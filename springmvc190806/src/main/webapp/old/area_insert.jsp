...
<body style="background-color: ">
	...
	<div class="container" >
		...
		<form action="/springmvc190806/areainfocontroller/doinsert"
			method="post">
				...
				<div class="panel-body">
					...
					<table class="table">
						<tr>
							...
							<td style="width:250px"><input type="text" name="aname" class="form-control"></td>
							<td></td>
						...
						<tr>
							<td>行政级别：</td>
							<td>
							<label><input checked="checked" type="radio"name="alevel" value="1">国家</label>
							
							&nbsp; &nbsp; 
							<label><input type="radio" name="alevel" value="2">省/直辖市/州</label>
							
							&nbsp; &nbsp; 
							<label><input type="radio" name="alevel" value="3">地级市</label>
						...
						<tr>
							<td>上级地区：</td>
							<td><select name="aparentid" class="form-control" >
									<%
										for (Areainfo area : areas) {
									%>

									<option value="<%=area.getAid()%>"><%=area.getAname()%></option>
